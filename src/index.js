...
client.on('ready', async () => {
    console.log(`${chalk.hex(client.config.colors.info)(figlet.textSync('Eastside', { horizontalLayout: 'full' }))}\n`);
...
client.on('interactionCreate', (interaction) => {
    if(!interaction.isCommand() || interaction.isContextMenu()) return; // since we dont really have a use for components yet
