    ...
    slashOptions: [
        {
            type: 'STRING',
            name: 'username',
            description: 'The username of the user you want to rank.',
            required: true
        },
        {
            type: 'STRING',
            name: 'role',
            description: 'The name or rank of the role you want to rank the specified user to.',
            required: true
        },
        {
            type: 'STRING',
            name: 'reason',
            description: 'The reason for setting the role to a user.',
            required: true
        }
    ]
}
